...
<Steps>
  <Step title="Install the package">Run `pnpm add @zpress/kit` to install zpress.</Step>
  <Step title="Create a config file">Add a `zpress.config.ts` file to your project root.</Step>
