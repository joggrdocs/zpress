...
import { SectionCard, SectionGrid, FeatureCard, FeatureGrid, WorkspaceCard, WorkspaceGrid } from '@theme'

# Cards

zpress ships three card component pairs for building landing pages and content grids. All are available in MDX files via `@theme`.
