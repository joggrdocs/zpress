...
| ------------------------------------------------------------- | ----- | ------------------------------ |
| [Languages](/references/icons/technology/languages)           | 25    | TypeScript, etc.               |
| [Frameworks](/references/icons/technology/frameworks)         | 31    | React, Hono, Flutter, etc.     |
| [Databases](/references/icons/technology/databases)           | 21    | PostgreSQL, Prisma, etc.       |
| [Infrastructure](/references/icons/technology/infrastructure) | 34    | Vercel, Docker, Grafana, etc.  |
| [Tooling](/references/icons/technology/tooling)               | 33    | Vite, Tailwind CSS, Jest, etc. |
| [Integrations](/references/icons/technology/integrations)     | 25    | OAuth, OpenAI, Strapi, etc.    |
