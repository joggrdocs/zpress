...
See [Recommended](/documentation-framework/recommended) for the full recommended layout.

## References

- [Diataxis](https://diataxis.fr) — the framework that inspired this approach
- [Types](/documentation-framework/types) — detailed breakdown of each doc type
- [Recommended](/documentation-framework/recommended) — the recommended section layout
