...
| # | Step | What it does |
| --- | --- | --- |
| 1 | Collect configs | Gather OpenAPI configs from root `config.openapi` and workspace `.openapi` fields |
| 2 | Check mtime | Stat spec file, compare against previous manifest -- skip dereference when unchanged |
